...
<p align="right">
<a href="http://godoc.org/github.com/admpub/go-figure"><img src="http://godoc.org/github.com/admpub/go-figure?status.svg" /></a>
<a href="https://goreportcard.com/report/github.com/admpub/go-figure"><img src="https://goreportcard.com/badge/github.com/admpub/go-figure" /></a>
</p>
...
## Installation
`go get github.com/admpub/go-figure`
...
import(
    ...
    _ "github.com/admpub/go-figure/fonts" // load all fonts
    // _ "github.com/admpub/go-figure/fonts/alphabet" // load a specific font
)
...
```go
func main() {
  myFigure := figure.NewColorFigure("Hello World", "", figure.Green, true)
  myFigure.Print()
}
```
